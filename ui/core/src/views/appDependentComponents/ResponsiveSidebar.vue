<template>
<nav ref="sidebar" class="sidebar px-0 pt-0" :class="{toggled:toggled,menutoggled:menutoggled}">
  <div ref="bgLayerContainer" style="display: none;">
    <div ref="bgLayer" v-show="menutoggled" @click="menuToggle" class="sidebar-bg-layer">
      <i class="material-icons sidebar-close-btn">
        close
      </i>
    </div>
  </div>
