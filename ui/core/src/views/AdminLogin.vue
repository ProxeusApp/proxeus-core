    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body px-3">
          ...
          <div class="c8 lst-kix_list_51-0 start" start="1">
            <div class="c7"><h1><span class="c6 c12">1. General</span></h1></div>
          </div>
          ...
          <div class="c8 lst-kix_list_51-1 start" start="1">
            <div class="c11"><h2 style="display:inline"><span class="c2">1.1 Usage</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-0" start="2">
            <div class="c10"><h1><span class="c6 c12">2. Account</span></h1></div>
          </div>
          <div class="c8 lst-kix_list_51-1 start" start="1">
            <div class="c11"><h2 style="display:inline"><span class="c2">2.1 Account password and security</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-0" start="3">
            <div class="c7"><h1><span class="c6 c12">3. The Services</span></h1></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-1" start="2">
            <div class="c11"><h2 style="display:inline"><span class="c2">3.1 Service Content</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-1" start="3">
            <div class="c11"><h2 style="display:inline"><span class="c2">3.2 Service security</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <p class="c1"><span
            ...
            class="c4">.</span></p>
          <div class="c8 lst-kix_list_51-1" start="5">
            <div class="c11"><h2 style="display:inline"><span class="c2">3.4 Service disruption</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-0" start="4">
            <div class="c7"><h1><span>4. Privacy policy and data protection</span></h1></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-0" start="5">
            <div class="c10"><h1><span
              class="c6 c12">5. Representations, warranties and risks</span></h1></div>
          </div>
          <div class="c8 lst-kix_list_51-1 start" start="1">
            <div class="c11"><h2 style="display:inline"><span class="c2">5.1 Warranty disclaimer</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-1" start="2">
            <div class="c11"><h2 style="display:inline"><span class="c2">5.2 Risk of cryptographic systems</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-1" start="3">
            <div class="c11"><h2 style="display:inline"><span
              class="c2">5.3 Risk of regulatory actions in one or more jurisdiction</span>
            </h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-1" start="4">
            <div class="c11"><h2 style="display:inline"><span class="c2">5.4 Volatility of cryptocurrencies</span></h2>
            </div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-1" start="5">
            <div class="c11"><h2 style="display:inline"><span class="c2">5.5 Application security</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-0" start="6">
            <div class="c7"><h1><span class="c6 c12">6. General user obligations</span></h1></div>
          </div>
          <div class="c8 lst-kix_list_51-1 start" start="1">
            <div class="c11"><h2 style="display:inline"><span class="c2">6.1 General</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_51-1" start="2">
            <div class="c11"><h2 style="display:inline"><span class="c2">6.2 Prohibited acts</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <ul class="c8 lst-kix_ek190fjkpfvz-0 start">
            <div class="c20"><span class="c4">content that is pornographic, obscene or immoral in nature;</span></div>
            <div class="c3"><span
          ...
          <ul class="c8 lst-kix_ek190fjkpfvz-0">
            ...
            <div class="c3"><span
              class="c6 c4">sending of junk, spam or scam mails as well as &ldquo;chainmail&rdquo;;</span></div>
            <div class="c3"><span class="c4 c6">utilisation of the Services for spam purposes or SEO spam;</span></div>
            <div class="c3"><span
          ...
          <div class="c8 lst-kix_list_54-0 start" start="7">
            <div class="c10"><h1><span class="c6 c12">7. Intellectual property rights</span></h1>
            </div>
          </div>
          <div class="c8 lst-kix_list_54-1 start" start="1">
            <div class="c11"><h2 style="display:inline"><span class="c2">7.1 Responsibility for User Content</span></h2>
            </div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_54-1" start="2">
            <div class="c11"><h2 style="display:inline"><span class="c2">7.2 Sharing of Service Content</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_54-0" start="8">
            <div class="c7"><h1><span class="c6 c12">8. Limitations of liability</span></h1></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_54-0" start="9">
            <div class="c10"><h1><span class="c6 c12">9. Miscellaneous provisions</span></h1></div>
          </div>
          <div class="c8 lst-kix_list_54-1 start" start="1">
            <div class="c11"><h2 style="display:inline"><span class="c2">9.1 Severability clause</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_54-1" start="2">
            <div class="c11"><h2 style="display:inline"><span class="c2">9.2 Amendments</span></h2></div>
          </div>
          <p class="c1"><span
          ...
          <div class="c8 lst-kix_list_54-1" start="3">
            <div class="c11"><h2 style="display:inline"><span>9.3 Jurisdiction and applicable </span><span>law</span></h2>
            </div>
          </div>
