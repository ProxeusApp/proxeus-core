<template>
  <div>
    ...
    >
      <div class="row">
        <div
          class="col-6 mt-3 text-center d-flex align-items-center border-right"
        ...
        >
          <div class="mid align-self-center w-100">
            ...
            <p class="light-text">
              {{ $t("Use your MetaMask Wallet to log in.") }}
            </p>
            ...
            >
              {{ $t("Log in with Metamask") }}
            </button>
          </div>
        </div>
        <div
          :class="{
            'col-6': metamaskLoginAvailable,
            'col-12': metamaskLoginAvailable === false,
          }"
        >
          <form class="text-center" @submit.prevent="login">
            ...
            <div class="text-danger mb-3" v-show="hasError">
              {{ loginErrorMessage }}
            </div>
            <div class="form-group">
              <router-link
