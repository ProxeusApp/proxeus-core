...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="max-height: 60px;">
  ...
  <a href="/" class="navbar-brand">
    ...
    <div v-else-if="this.$t('Logo url') === 'Proxeus'">
    ...
    <div v-else>
      <img v-bind:src="this.$t('Logo url')" alt="" height="60"/>
    </div>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <!--</li>-->
    <!--<li class="nav-item">-->
    <!--<button type="button" class="nav-link btn btn-info ml-2" data-toggle="modal" data-target="#wallet-component">Wallet</button>-->
    <!--</li>-->
    <!--        <li class="" v-if="$route.name !== 'Login' && $route.name !== 'AdminLogin'">-->
    <!--          <a class="btn btn-primary text-white px-3 ml-2" href="/login">Beta Access</a>-->
    <!--        </li>-->
  </ul>
  <top-right-profile/>
</nav>
