    ...
    <div>
      <nav-tabs class="mt-0">
        ...
        <tab title="Export">
                            ...
                            <div class="row">
                              <div class="col-md-3">
                                <checkbox
                                  :title="
                                    $t(
                                      'Export UserData explanation',
                                      'Choose to include the data that is being resulted by workflow executions'
                                    )
                                  "
                                  :label="'UserData'"
                                  v-model="ex.UserData"
                              ...
                              <div class="col-md-3">
                                <checkbox
                                  :title="
                                    $t(
                                      'Export Doc Template explanation',
                                      'Choose to include the document template entries'
                                    )
                                  "
                                  :label="'Template'"
                                  v-model="ex.Template"
                              ...
                              <div class="col-md-3">
                                <checkbox
                                  :title="
                                    $t(
                                      'Export Form explanation',
                                      'Choose to include the forms'
                                    )
                                  "
                                  :label="'Form'"
                                  v-model="ex.Form"
                                ...
                                <checkbox
                                  :title="
                                    $t(
                                      ...
                                      'Choose to include the workflows'
                                    )
                                  "
                                  :label="'Workflow'"
                                  v-model="ex.Workflow"
                              ...
                              <div
                                class="col-md-3"
                                v-if="app.userIsSuperAdmin()"
                              >
                                <checkbox
                                  :title="
                                    $t(
                                      'Export User explanation',
                                      'Choose to include the users'
                                    )
                                  "
                                  :label="'User'"
                                  v-model="ex.User"
                              ...
                              >
                                <checkbox
                                  :title="
                                    $t(
                                      'Export I18n explanation',
                                      'Choose to include internationalization'
                                    )
                                  "
                                  :label="'I18n'"
                                  v-model="ex.I18n"
                                ...
                                <checkbox
                                  :title="
                                    $t(
                                      ...
                                      'Choose to include the system settings'
                                    )
                                  "
                                  :label="'Settings'"
                                  v-model="ex.Settings"
          ...
          <div
            v-if="lastExportResults"
            class="tabcontent"
            style="margin-top: 15px; position: relative"
          >
            <span
              class="imexclose"
              @click="app.loadLastExportResults(updateExportResults, 'delete')"
              >&#10799;</span
            >
            <h5>
