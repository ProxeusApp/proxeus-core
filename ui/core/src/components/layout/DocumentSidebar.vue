<template>
  <nav
    class="col-md-3 col-lg-2 d-none d-md-block app-sidebar px-0 pt-0"
  ...
  >
    ...
    <nav class="collapse show sidebar-sticky">
      <nav class="nav main-nav flex-column">
        ...
        <li class="nav-item">
          <router-link :to="{ name: 'Templates' }" class="nav-link"
            ><span class="material-icons">web</span
            ><span class="nav-link-title">Templates</span>
          </router-link>
        </li>
        <li class="nav-item">
          <router-link :to="{ name: 'Forms' }" class="nav-link"
        ...
        <li class="nav-item">
          <router-link :to="{ name: 'I18n' }" class="nav-link"
            ><span class="material-icons">language</span
            ><span class="nav-link-title">Localization</span>
          </router-link>
        </li>
      </nav>
    </nav>
