...
waitforproxeus=echo "Waiting for Proxeus to start" ; curl --head -X GET --retry 120 --retry-connrefused --retry-delay 1 --silent -o /dev/null http://$(DOCKER_GATEWAY):1323 && echo "Proxeus started" || echo "Unable to start Proxeus"
